  ...
  return (
    <div className='doublepillorangegradient'>
      <div className='relative h-fit pt-[100px] flex flex-col items-center z-10 bg-gray-100'>
        <div className='w-[90%] mt-2 flex flex-col justify-center items-center pl-[10%] lg:pr-[200px] md:pr-[200px] sm:pr-[50px] z-10 mb-[120px]'>
            <h1 className="text-[#43BCCD] font-lato text-[28px] tracking-tighter font-semibold mb-3">
                OUR MISSION
            </h1>
            <p className={`text-black font-poppins px-8 lg:text-[24px] md:text-[20px] sm:text-[15px] tracking-wide font-normal leading-normal`}>
      ...
      <div className='relative h-fit pt-[200px] pb-[100px] flex flex-col items-start z-10 doublepillgradient leading-snug'
        ...
        <div className="w-[90%] mx-16 pr-16 lg:pr-0 lg:w-2/5 lg:ml-48">
          ...
          <p className = {`${styles.paragraph2} !text-[24px]`}>
            We strive to
            <span className="font-[900]"
              style={{
      ...
      <div className="ml-6 sm:ml-16 py-32 relative items-center">
        <div className='flex flex-col-reverse md:flex-row justify-center leading-relaxed items-center md:mb-20 pt-32 pb-7 h-fit  2xl:ml-[17%] 2xl:w-[70%] xl:ml-4'>
          <div className='my-5 w-[80%]'>
            ...
            <p className="leading-[25px] font-poppins font-normal text-primary text-[20px] xl:text-[23px] mb-4 leading-relaxed">From high-quality outreach to machine-learning-powered targeting, each cent contributed to the New Way Forward will be reflected in your campaign's success. </p>
          </div>
          <div className='hidden md:block pl-4 xl:pl-28'>
            <h3 className='text-[#43BCCD] ml-[-10px] sm:my-5 font-poppins text-[23px] !font-bold leading-normal tracking-widest'>Company History</h3>
              <div className="timeline-container h-full">
                  {mission_tags.map((event) => (
                      <div className="timeline-event">
                          <h3 className='text-white font-bold mb-1 text-[24px]'>{event.date}</h3>
                          <p className='text-white text-[20px]'>{event.description}</p>
                      </div>
                  ))}
              </div>
          </div>
