  ...
  return (
    <>
        ...
        <div className="max-w-[1200px] mx-auto px-4 relative">  
            ...
            <img src={mcduffie_logo} alt="McDuffie Logo" className="hidden 2xl:block w-40" style={{ position: 'absolute', left: 'calc(70% + 32px)', top: '315px' }} />
        ...
        <div className="max-w-[1200px] mx-auto px-4 lg:pr-[400px] relative">  
            ...
            <img src={mcduffie_graph} alt="McDuffie Graph" className="relative mx-auto mt-[-1rem] hidden 2xl:block h-[21.5rem] w-[788px] object-cover overflow-hidden" />
        </div>
