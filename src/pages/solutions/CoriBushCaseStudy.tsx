        ...
        <div className="doublepillgradient">
            ...
            <div className="max-w-[1100px] 2xl:max-w-[1200px] mx-auto px-4 lg:pr-[400px] relative">
                ...
                <div className="text-lg lg:text-xl text-white mb-6">
                    In Q2, we coordinated their email and text teams, and built a more cohesive digital strategy to demonstrate immediate ROI and momentum.
                </div>

                <ul className="list-disc list-inside text-lg lg:text-xl text-white space-y-6 mb-12">
                    <li><span className="font-bold text-greenBlue">Digital Strategy Overhaul:</span> NWF provided more than 25,000 contacts for text and email. These donated contacts paid for NWF's entire cost. We implemented sophisticated segmentation and personalized messaging to dramatically increase conversion rates.</li>
                    <li><span className="font-bold text-greenBlue">High-Dollar Event Program:</span> NWF built a high-dollar event program which started with multiple $75,000 fundraising trips in NYC and California. We cultivated relationships with major donors, organized intimate gatherings, and created compelling asks.</li>
                    <li><span className="font-bold text-greenBlue">Campaign Transformation:</span> From a debt-ridden campaign to a machine raising over $100k/day, we implemented rigorous financial planning to turn the ship around.</li>
                </ul>

                <h2 className="text-2xl text-white font-bold mb-4">Execution & Results</h2>
                <div className="text-lg lg:text-xl text-white mb-6">
                    The transformation of Rep. Bush's fundraising operation demonstrates how strategic planning, digital innovation, and high-dollar cultivation can work together to overcome significant financial challenges.
                </div>
                <ul className="list-disc list-inside text-lg lg:text-xl text-white space-y-6 mb-12">
                ...
                <div className="text-lg lg:text-xl text-white mb-8">
                    From a debt-ridden campaign to a multi-million dollar quarter, NWF's comprehensive approach proved that with the right strategy and execution, even the most difficult fundraising situations can be turned around.
                </div>
            </div>
