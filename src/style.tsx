const styles = {
  ...
  landingbutton:
    ...
    "bg-none hover:bg-opacity-25 hover:bg-greenBlue border-2 border-greenBlue text-greenBlue w-fit rounded-md py-2 px-5 font-poppins font-light mt-5 md:text-md 2xl:text-3xl",
  
  landingbutton2:
    "bg-none hover:bg-opacity-25 hover:bg-brownish border-2 border-brownish text-brownish w-fit rounded-md py-2 px-5 font-poppins font-light mt-5 md:text-md 2xl:text-3xl",
