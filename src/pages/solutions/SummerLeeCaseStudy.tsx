...
const SummerLeeCaseStudy = () => {
    ...
    return (
        <div className="doublepillgradient">
            <SEO
                title="Summer Lee Case Study"
                description="How NWF Strategies helped Rep. Summer Lee raise over $3 million and outperform the entire PA congressional delegation through aggressive fundraising and digital strategy."
                canonical="/solutions/summer-lee-2024"
            />
