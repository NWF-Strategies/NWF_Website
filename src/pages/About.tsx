  ...
  return (
    <div className=''>
      <div className='relative h-fit py-[100px] blue__black__gradient flex flex-col items-center z-10'>
        ...
        <div className='flex md:flex-row xs:flex-col justify-between items-center px-20 sx:px-5 w-full xl:w-[70%] lg:w-[100%] '>
          <div className='card-container md:w-[45%] md:mb-0 xs:w-[80%] xs:mb-10 h-fit'>
            <p className='mission-card bg-[#185767] text-white md:px-[70px] md:py-[50px] xs:px-[15px] xs:py-[10px] rounded-lg relative z-10'>
      ...
      <div className='timeline-section pb-10 flex flex-col w-full items-center'>
        <div className='flex flex-row justify-center items-center mb-20 py-10 w-[80%] h-fit'>
