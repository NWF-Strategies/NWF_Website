...
const Career = () => {
  return (
    <div className="doublepillgradient w-full">
      <div className='relative min-h-screen h-auto w-full flex items-start justify-center flex-col z-10 mb-32 md:mb-[300px]'>
        ...
        <FadeIn delay={0} duration={1200}>
          <SlideIn direction="left" delay={100} duration={700}>
            <div className="relative mx-auto md:ml-24 mt-32 md:mt-56 py-6 px-6 md:py-12 md:px-12 z-10 w-full max-w-[810px] bg-[rgba(24,24,24,0.75)] backdrop-blur-[2px] p-4 rounded-[15px] flex flex-col justify-center">
              <img src={new_logo} alt="nwf" className="w-[120px] md:w-[220px] lg:w-[260px] h-auto md:h-[40px] outline-none focus:ring-0 focus:outline-none mb-4 md:mb-0" />
              <h3 className="text-5xl md:text-[4rem] font-lato tracking-normal font-normal text-white text-left break-words">
                Careers
              </h3>
              <div className="pb-3 pr-0 xl:pr-1">
                <p className="text-lg md:text-[1.63rem] font-lato text-white leading-normal mb-0 text-left">
      ...
      <div className='flex justify-center w-full items-center relative mt-[-100px] md:mt-[-190px] '>
        <div className='flex flex-col items-center pb-10 justify-center max-w-7xl w-full'>
          <div className='h-fit pb-10 px-10 mb-10 w-full'>
            <div className="relative w-full bg-gray-700 bg-opacity-40 backdrop-blur-[2px] px-6 pt-4 pb-14 rounded-[15px]">
              <div className="font-poppins flex items-center justify-center">
                <h1 className="text-cyan-400 text-4xl md:text-[3rem] font-semibold tracking-wide text-center">Teams</h1>
              </div>
              <FadeIn delay={300}>
          ...
          <hr></hr>
          <div className="pb-6 px-6 md:px-16 mr-0">
