...
export const landing_solutions = [
    { content: landing_sol1, imageSrc: careers_role01, imageAlt: 'Strategy image' },
    { content: landing_sol2, imageSrc: careers_role02, imageAlt: 'Marketing image' },
    { content: landing_sol3, imageSrc: careers_role03, imageAlt: 'Development image' },
    { content: landing_sol4, imageSrc: careers_role04, imageAlt: 'Operations image' }
];
